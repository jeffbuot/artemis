 ...
 * @author Jefferson
 */
public class PermissionsLogViewer extends javax.swing.JDialog {
    ...
    public PermissionsLogViewer(Component comp,boolean t) {
        this.file = new File(t?"responses.xml":"permissions.xml");
        initComponents();
        setModal(true);
    ...
    private void initTable() {
        List<PermissionRequest> tmp = ChromieDB.loadListData(file, PermissionRequest.class);
        this.pr = new PermissionRequest[tmp.size()];
        int h = 0;
        for (int n = pr.length - 1; n >= 0; n--) {
            pr[h++] = tmp.get(n);
        }
        ...
        tmp.forEach(l -> dtm.addRow(new String[]{l.getDate(), l.getNote(), l.getInstituteToBeSent(), l.getSender().getAdminName(), l.getStatus()}));
        table.setModel(dtm);
    ...
    public static void showDialog(Component c) {
        new PermissionsLogViewer(c,false).setVisible(true);
    }
    public static void showResponseLogs(Component c) {
        new PermissionsLogViewer(c,true).setVisible(true);
    }
    /**
    ...
    private void deleteSelected() {
        ...
        if (ArtemisConfirm.showDialog(this, "Confirm Delete", "Are you sure you "
            ...
            ArrayList<PermissionRequest> li = new ArrayList<>();
            for (int r = pr.length - 1; r >= 0; r--) {
                if (pr[r] != null) {
                    li.add(pr[r]);
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PermissionsLogViewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
